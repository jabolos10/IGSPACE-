...
void Game::render() {
    ...
    case GameState::Menu:
        ...
        // Drawing some game objects as a teaser
    ...
    window.display(); // Displaying the drawn content
}
        ...
        for (auto bulletIt = ship->handleToContainerOnBullets()->begin(); bulletIt != ship->handleToContainerOnBullets()->end(); ) {
            ...
            for (auto enemyIt = enemyShips.begin(); enemyIt != enemyShips.end(); ) {
                ...
                if ((*enemyIt)->collidesWith(*bulletIt)) {
                    ...
                    // Creating floating Health points and score gained at a random position after shooting EnemyShip type 2
                    try {
...
void Game::update(sf::Time dt) {
    ...
    // Check for collisions with 2nd type of ships
